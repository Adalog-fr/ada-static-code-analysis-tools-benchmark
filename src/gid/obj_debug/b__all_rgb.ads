...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_all_rgb" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9041aac8#;
   pragma Export (C, u00001, "all_rgbB");
   ...
   u00143 : constant Version_32 := 16#a5571fec#;
   pragma Export (C, u00143, "ada__strings__unboundedB");
   u00144 : constant Version_32 := 16#efe6e98c#;
   ...
   u00147 : constant Version_32 := 16#21641b9a#;
   ...
   u00151 : constant Version_32 := 16#7b453c33#;
   ...
   u00155 : constant Version_32 := 16#085a4f55#;
   ...
   u00161 : constant Version_32 := 16#67eb6d5a#;
   pragma Export (C, u00161, "ada__text_ioB");
   u00162 : constant Version_32 := 16#3cf1122b#;
   pragma Export (C, u00162, "ada__text_ioS");
   u00163 : constant Version_32 := 16#2bcafb82#;
   pragma Export (C, u00163, "gidB");
   u00164 : constant Version_32 := 16#cc9e089d#;
   pragma Export (C, u00164, "gidS");
   u00165 : constant Version_32 := 16#0c07b229#;
   pragma Export (C, u00165, "gid__decoding_bmpB");
   u00166 : constant Version_32 := 16#f83d5c30#;
   pragma Export (C, u00166, "gid__decoding_bmpS");
   u00167 : constant Version_32 := 16#968d21a9#;
   pragma Export (C, u00167, "gid__bufferingB");
   u00168 : constant Version_32 := 16#cfa0328e#;
   pragma Export (C, u00168, "gid__bufferingS");
   u00169 : constant Version_32 := 16#0c67333d#;
   pragma Export (C, u00169, "gid__decoding_gifB");
   u00170 : constant Version_32 := 16#95cfdbb5#;
   pragma Export (C, u00170, "gid__decoding_gifS");
   u00171 : constant Version_32 := 16#041f516b#;
   pragma Export (C, u00171, "gid__color_tablesB");
   u00172 : constant Version_32 := 16#fb59515d#;
   pragma Export (C, u00172, "gid__color_tablesS");
   u00173 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00173, "system__concat_2B");
   u00174 : constant Version_32 := 16#f796dc4f#;
   pragma Export (C, u00174, "system__concat_2S");
   u00175 : constant Version_32 := 16#022a3ef5#;
   pragma Export (C, u00175, "gid__decoding_jpgB");
   u00176 : constant Version_32 := 16#c9ed4a94#;
   pragma Export (C, u00176, "gid__decoding_jpgS");
   u00177 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00177, "ada__integer_text_ioB");
   u00178 : constant Version_32 := 16#dc1f7556#;
   pragma Export (C, u00178, "ada__integer_text_ioS");
   u00179 : constant Version_32 := 16#44bc8f6a#;
   pragma Export (C, u00179, "ada__text_io__generic_auxB");
   u00180 : constant Version_32 := 16#ba6faca0#;
   pragma Export (C, u00180, "ada__text_io__generic_auxS");
   u00181 : constant Version_32 := 16#8b9a2c46#;
   pragma Export (C, u00181, "system__img_biuS");
   u00182 : constant Version_32 := 16#c6c4eb98#;
   pragma Export (C, u00182, "system__img_llbS");
   u00183 : constant Version_32 := 16#602bc0ef#;
   pragma Export (C, u00183, "system__img_lliS");
   u00184 : constant Version_32 := 16#ad0ace1a#;
   pragma Export (C, u00184, "system__wid_lluS");
   u00185 : constant Version_32 := 16#b1351eea#;
   pragma Export (C, u00185, "system__img_lllbS");
   u00186 : constant Version_32 := 16#868c229b#;
   pragma Export (C, u00186, "system__img_llliS");
   u00187 : constant Version_32 := 16#eaaea841#;
   pragma Export (C, u00187, "system__val_llliS");
   u00188 : constant Version_32 := 16#5ce094b2#;
   pragma Export (C, u00188, "system__val_llluS");
   u00189 : constant Version_32 := 16#ceb71b59#;
   pragma Export (C, u00189, "system__wid_llluS");
   u00190 : constant Version_32 := 16#bb4107e6#;
   pragma Export (C, u00190, "system__img_lllwS");
   u00191 : constant Version_32 := 16#9af69e93#;
   pragma Export (C, u00191, "system__img_llwS");
   u00192 : constant Version_32 := 16#b4409774#;
   pragma Export (C, u00192, "system__img_wiuS");
   u00193 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00193, "system__concat_3B");
   u00194 : constant Version_32 := 16#c817b61a#;
   pragma Export (C, u00194, "system__concat_3S");
   u00195 : constant Version_32 := 16#7f5b11f9#;
   pragma Export (C, u00195, "gid__decoding_pngB");
   u00196 : constant Version_32 := 16#02e7cb31#;
   pragma Export (C, u00196, "gid__decoding_pngS");
   u00197 : constant Version_32 := 16#e6e0265c#;
   pragma Export (C, u00197, "gid__decoding_png__huffmanB");
   u00198 : constant Version_32 := 16#39874414#;
   pragma Export (C, u00198, "gid__decoding_png__huffmanS");
   u00199 : constant Version_32 := 16#3124cfea#;
   pragma Export (C, u00199, "system__concat_8B");
   u00200 : constant Version_32 := 16#cfe2ff79#;
   pragma Export (C, u00200, "system__concat_8S");
   u00201 : constant Version_32 := 16#0e0e78c8#;
   pragma Export (C, u00201, "system__val_enum_16S");
   u00202 : constant Version_32 := 16#64082409#;
   pragma Export (C, u00202, "gid__decoding_pnmB");
   u00203 : constant Version_32 := 16#16bfc7c5#;
   pragma Export (C, u00203, "gid__decoding_pnmS");
   ...
   u00226 : constant Version_32 := 16#ebb39bbb#;
   pragma Export (C, u00226, "system__concat_5B");
   u00227 : constant Version_32 := 16#02f47e63#;
   pragma Export (C, u00227, "system__concat_5S");
   u00228 : constant Version_32 := 16#02cecc7b#;
   pragma Export (C, u00228, "system__concat_6B");
   u00229 : constant Version_32 := 16#c03f5eb0#;
   pragma Export (C, u00229, "system__concat_6S");
   u00230 : constant Version_32 := 16#2f074c64#;
   pragma Export (C, u00230, "system__img_fixed_64S");
   u00231 : constant Version_32 := 16#0943a5da#;
   pragma Export (C, u00231, "system__arith_64B");
   u00232 : constant Version_32 := 16#8d22fd0d#;
   pragma Export (C, u00232, "system__arith_64S");
   u00233 : constant Version_32 := 16#3c5e65e9#;
   pragma Export (C, u00233, "system__exn_lliS");
   u00234 : constant Version_32 := 16#4f0058da#;
   pragma Export (C, u00234, "system__img_utilB");
   u00235 : constant Version_32 := 16#35740b01#;
   pragma Export (C, u00235, "system__img_utilS");
   u00236 : constant Version_32 := 16#806550ce#;
   pragma Export (C, u00236, "system__random_numbersB");
   u00237 : constant Version_32 := 16#33b60f12#;
   pragma Export (C, u00237, "system__random_numbersS");
   u00238 : constant Version_32 := 16#a778ef81#;
   pragma Export (C, u00238, "system__random_seedB");
   u00239 : constant Version_32 := 16#563f4d49#;
   pragma Export (C, u00239, "system__random_seedS");
   u00240 : constant Version_32 := 16#92946bcf#;
   pragma Export (C, u00240, "system__val_enum_8S");
