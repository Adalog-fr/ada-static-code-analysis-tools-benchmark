pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__mini.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__mini.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_mini");
...
--  BEGIN Object file/option list
   ...
   --   /workspaces/bench-source/src/gid/obj_debug/mini.o
