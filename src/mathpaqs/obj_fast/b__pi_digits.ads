...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_pi_digits" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e2c3a196#;
   pragma Export (C, u00001, "pi_digitsB");
   ...
   u00153 : constant Version_32 := 16#1c242571#;
   pragma Export (C, u00153, "multi_precision_integersB");
   u00154 : constant Version_32 := 16#8d0f3442#;
   pragma Export (C, u00154, "multi_precision_integersS");
   u00155 : constant Version_32 := 16#67683615#;
   pragma Export (C, u00155, "multi_precision_integers__checkB");
   u00156 : constant Version_32 := 16#c45ba990#;
   pragma Export (C, u00156, "multi_precision_integers__checkS");
   u00157 : constant Version_32 := 16#5c4d4910#;
   pragma Export (C, u00157, "multi_precision_integers__ioB");
   u00158 : constant Version_32 := 16#662d9413#;
   pragma Export (C, u00158, "multi_precision_integers__ioS");
   u00159 : constant Version_32 := 16#585f81ee#;
   pragma Export (C, u00159, "system__img_lluS");
   u00160 : constant Version_32 := 16#7d9ea9cb#;
   pragma Export (C, u00160, "text_ioS");
   ...
   --  system.img_llu%s
   --  text_io%s
   --  multi_precision_integers%s
   --  multi_precision_integers.check%s
   --  multi_precision_integers%b
   --  multi_precision_integers.io%s
   --  multi_precision_integers.io%b
   --  multi_precision_integers.check%b
   --  pi_digits%b
