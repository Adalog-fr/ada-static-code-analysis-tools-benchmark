...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_champ_vt" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4c8e4aa0#;
   pragma Export (C, u00001, "champ_vtB");
   ...
   u00103 : constant Version_32 := 16#dc1b3a37#;
   pragma Export (C, u00103, "ada__numerics__elementary_functionsB");
   u00104 : constant Version_32 := 16#007d625c#;
   pragma Export (C, u00104, "ada__numerics__elementary_functionsS");
   ...
   u00110 : constant Version_32 := 16#e77d8041#;
   pragma Export (C, u00110, "system__exn_fltS");
   u00111 : constant Version_32 := 16#815f70d4#;
   pragma Export (C, u00111, "system__fat_fltS");
   u00112 : constant Version_32 := 16#a201b8c5#;
   pragma Export (C, u00112, "ada__strings__text_buffersB");
   u00113 : constant Version_32 := 16#a7cfd09b#;
   pragma Export (C, u00113, "ada__strings__text_buffersS");
   u00114 : constant Version_32 := 16#8b7604c4#;
   pragma Export (C, u00114, "ada__strings__utf_encodingB");
   u00115 : constant Version_32 := 16#4d0e0994#;
   pragma Export (C, u00115, "ada__strings__utf_encodingS");
   u00116 : constant Version_32 := 16#bb780f45#;
   pragma Export (C, u00116, "ada__strings__utf_encoding__stringsB");
   u00117 : constant Version_32 := 16#b85ff4b6#;
   pragma Export (C, u00117, "ada__strings__utf_encoding__stringsS");
   u00118 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00118, "ada__strings__utf_encoding__wide_stringsB");
   u00119 : constant Version_32 := 16#5678478f#;
   ...
   u00121 : constant Version_32 := 16#d7af3358#;
   pragma Export (C, u00121, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00122 : constant Version_32 := 16#6e9a9dee#;
   pragma Export (C, u00122, "ada__tagsB");
   u00123 : constant Version_32 := 16#d00a1748#;
   pragma Export (C, u00123, "ada__tagsS");
   u00124 : constant Version_32 := 16#3548d972#;
   pragma Export (C, u00124, "system__htableB");
   u00125 : constant Version_32 := 16#c3b4f753#;
   pragma Export (C, u00125, "system__htableS");
   u00126 : constant Version_32 := 16#1f1abe38#;
   pragma Export (C, u00126, "system__string_hashB");
   u00127 : constant Version_32 := 16#64f1772c#;
   pragma Export (C, u00127, "system__string_hashS");
   u00128 : constant Version_32 := 16#935be1d7#;
   pragma Export (C, u00128, "graphB");
   u00129 : constant Version_32 := 16#47a964fb#;
   pragma Export (C, u00129, "graphS");
   ...
   u00146 : constant Version_32 := 16#f614af02#;
   pragma Export (C, u00146, "graph__postscript_driverB");
   u00147 : constant Version_32 := 16#e9f19bd3#;
   pragma Export (C, u00147, "graph__postscript_driverS");
   u00148 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00148, "ada__integer_text_ioB");
   u00149 : constant Version_32 := 16#dc1f7556#;
   pragma Export (C, u00149, "ada__integer_text_ioS");
   u00150 : constant Version_32 := 16#44bc8f6a#;
   pragma Export (C, u00150, "ada__text_io__generic_auxB");
   u00151 : constant Version_32 := 16#ba6faca0#;
   pragma Export (C, u00151, "ada__text_io__generic_auxS");
   u00152 : constant Version_32 := 16#8b9a2c46#;
   pragma Export (C, u00152, "system__img_biuS");
   u00153 : constant Version_32 := 16#c6c4eb98#;
   pragma Export (C, u00153, "system__img_llbS");
   u00154 : constant Version_32 := 16#602bc0ef#;
   pragma Export (C, u00154, "system__img_lliS");
   u00155 : constant Version_32 := 16#ad0ace1a#;
   pragma Export (C, u00155, "system__wid_lluS");
   u00156 : constant Version_32 := 16#b1351eea#;
   pragma Export (C, u00156, "system__img_lllbS");
   u00157 : constant Version_32 := 16#868c229b#;
   pragma Export (C, u00157, "system__img_llliS");
   u00158 : constant Version_32 := 16#eaaea841#;
   pragma Export (C, u00158, "system__val_llliS");
   u00159 : constant Version_32 := 16#5ce094b2#;
   pragma Export (C, u00159, "system__val_llluS");
   u00160 : constant Version_32 := 16#ceb71b59#;
   pragma Export (C, u00160, "system__wid_llluS");
   u00161 : constant Version_32 := 16#bb4107e6#;
   pragma Export (C, u00161, "system__img_lllwS");
   u00162 : constant Version_32 := 16#9af69e93#;
   pragma Export (C, u00162, "system__img_llwS");
   u00163 : constant Version_32 := 16#b4409774#;
   pragma Export (C, u00163, "system__img_wiuS");
   u00164 : constant Version_32 := 16#d2c8e6b0#;
   pragma Export (C, u00164, "time_displayB");
   u00165 : constant Version_32 := 16#d9e9756e#;
   pragma Export (C, u00165, "calendarS");
   u00166 : constant Version_32 := 16#a440ec49#;
   pragma Export (C, u00166, "ada__calendarB");
   u00167 : constant Version_32 := 16#8324cd02#;
   pragma Export (C, u00167, "ada__calendarS");
   u00168 : constant Version_32 := 16#307180be#;
   ...
   u00170 : constant Version_32 := 16#b59f703c#;
   pragma Export (C, u00170, "system__finalization_mastersB");
   u00171 : constant Version_32 := 16#9ff3107f#;
