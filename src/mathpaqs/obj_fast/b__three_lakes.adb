pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__three_lakes.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__three_lakes.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_three_lakes");
...
--  BEGIN Object file/option list
   --   /workspaces/bench-source/src/mathpaqs/obj_fast/three_lakes.o
