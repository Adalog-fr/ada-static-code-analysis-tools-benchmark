pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__xsnamest.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__xsnamest.adb");
...
package body ada_main is
   ...
   E169 : Short_Integer; pragma Import (Ada, E169, "gnat__spitbol__patterns_E");
   E184 : Short_Integer; pragma Import (Ada, E184, "xutil_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "gnat__spitbol__patterns__finalize_body");
      begin
         E169 := E169 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "gnat__spitbol__patterns__finalize_spec");
      begin
         F2;
      end;
      E176 := E176 - 1;
   ...
   begin
      ...
      E176 := E176 + 1;
      Gnat.Spitbol.Patterns'Elab_Spec;
      Gnat.Spitbol.Patterns'Elab_Body;
      E169 := E169 + 1;
      E184 := E184 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_xsnamest");
...
--  BEGIN Object file/option list
   --   /workspaces/bench-source/src/asis/gnat/xutil.o
   --   /workspaces/bench-source/src/asis/gnat/xsnamest.o
   --   -L/workspaces/bench-source/src/asis/gnat/
   --   -L/workspaces/bench-source/src/asis/gnat/
