...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_xsnamest" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d446e0ef#;
   pragma Export (C, u00001, "xsnamestB");
   ...
   u00125 : constant Version_32 := 16#5d191d0e#;
   ...
   u00137 : constant Version_32 := 16#a5571fec#;
   pragma Export (C, u00137, "ada__strings__unboundedB");
   u00138 : constant Version_32 := 16#efe6e98c#;
   ...
   u00155 : constant Version_32 := 16#f3e34733#;
   pragma Export (C, u00155, "ada__strings__unbounded__text_ioB");
   u00156 : constant Version_32 := 16#7acec133#;
   pragma Export (C, u00156, "ada__strings__unbounded__text_ioS");
   u00157 : constant Version_32 := 16#67eb6d5a#;
   pragma Export (C, u00157, "ada__text_ioB");
   u00158 : constant Version_32 := 16#3cf1122b#;
   pragma Export (C, u00158, "ada__text_ioS");
   u00159 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00159, "gnatS");
   u00160 : constant Version_32 := 16#2cb8a511#;
   pragma Export (C, u00160, "gnat__spitbolB");
   u00161 : constant Version_32 := 16#d2281168#;
   pragma Export (C, u00161, "gnat__spitbolS");
   u00162 : constant Version_32 := 16#219c8b10#;
   pragma Export (C, u00162, "ada__strings__unbounded__auxB");
   u00163 : constant Version_32 := 16#76f3eb0f#;
   pragma Export (C, u00163, "ada__strings__unbounded__auxS");
   u00164 : constant Version_32 := 16#824af034#;
   pragma Export (C, u00164, "gnat__debug_utilitiesB");
   u00165 : constant Version_32 := 16#f4e48424#;
   pragma Export (C, u00165, "gnat__debug_utilitiesS");
   u00166 : constant Version_32 := 16#8099c5e3#;
   pragma Export (C, u00166, "gnat__ioB");
   u00167 : constant Version_32 := 16#2a95b695#;
   pragma Export (C, u00167, "gnat__ioS");
   u00168 : constant Version_32 := 16#b28eaa56#;
   pragma Export (C, u00168, "gnat__spitbol__patternsB");
   u00169 : constant Version_32 := 16#23d67364#;
   pragma Export (C, u00169, "gnat__spitbol__patternsS");
   u00170 : constant Version_32 := 16#e6e7837e#;
   pragma Export (C, u00170, "system__exn_intS");
   u00171 : constant Version_32 := 16#b59f703c#;
   pragma Export (C, u00171, "system__finalization_mastersB");
   u00172 : constant Version_32 := 16#9ff3107f#;
   ...
   u00175 : constant Version_32 := 16#7c78c3c5#;
   pragma Export (C, u00175, "system__pool_globalB");
   u00176 : constant Version_32 := 16#0ca49a01#;
   ...
   u00179 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00179, "system__concat_2B");
   u00180 : constant Version_32 := 16#f796dc4f#;
   pragma Export (C, u00180, "system__concat_2S");
   u00181 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00181, "system__concat_3B");
   u00182 : constant Version_32 := 16#c817b61a#;
   pragma Export (C, u00182, "system__concat_3S");
   u00183 : constant Version_32 := 16#37063868#;
   pragma Export (C, u00183, "xutilB");
   u00184 : constant Version_32 := 16#1624c5ef#;
   pragma Export (C, u00184, "xutilS");
   u00185 : constant Version_32 := 16#bf56f131#;
   pragma Export (C, u00185, "system__strings__stream_opsB");
   u00186 : constant Version_32 := 16#ba9b6df2#;
   ...
   --  gnat.spitbol.patterns%s
   --  gnat.spitbol.patterns%b
