...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_touch2" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8eb70eb6#;
   pragma Export (C, u00001, "touch2B");
   ...
   u00141 : constant Version_32 := 16#57fb41fd#;
   pragma Export (C, u00141, "set_modification_time_gnatB");
   ...
   u00144 : constant Version_32 := 16#1982dcd0#;
   pragma Export (C, u00144, "system__memoryB");
   u00145 : constant Version_32 := 16#19e99d68#;
