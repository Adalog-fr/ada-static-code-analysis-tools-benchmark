pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__touch2.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__touch2.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_touch2");
...
--  BEGIN Object file/option list
   --   /workspaces/bench-source/src/zipada/obj_opt/set_modification_time_gnat.o
   --   /workspaces/bench-source/src/zipada/obj_opt/touch2.o
