...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_comp_zip" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4201a824#;
   pragma Export (C, u00001, "comp_zipB");
   ...
   u00223 : constant Version_32 := 16#3f1a37f3#;
   pragma Export (C, u00223, "show_licenseB");
