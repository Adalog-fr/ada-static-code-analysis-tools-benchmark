...
<b><font face=arial>
<a target=_top href=../index.html>Back to...</a></font></b><td>
<a target=_top href=../index.html><img border=1 width=222 height=33 alt='PDF Writer' src=../pw_title.png></a><td>
<a target=_top href=../index.html><IMG width=24 height=24 border=0 SRC=../backplat.gif></a></table>";
  }
  if ($adafile ne "")
  {
