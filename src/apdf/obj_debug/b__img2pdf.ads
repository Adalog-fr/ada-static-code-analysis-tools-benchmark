...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_img2pdf" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e5081a9f#;
   pragma Export (C, u00001, "img2pdfB");
   ...
   u00121 : constant Version_32 := 16#a17cca23#;
   pragma Export (C, u00121, "pdf_outB");
   u00122 : constant Version_32 := 16#949381dd#;
   pragma Export (C, u00122, "pdf_outS");
   ...
   u00129 : constant Version_32 := 16#b98a4d98#;
   pragma Export (C, u00129, "ada__strings__fixedB");
   u00130 : constant Version_32 := 16#1bd3eed0#;
   pragma Export (C, u00130, "ada__strings__fixedS");
   u00131 : constant Version_32 := 16#292c204f#;
   pragma Export (C, u00131, "ada__strings__searchB");
   u00132 : constant Version_32 := 16#20765109#;
   pragma Export (C, u00132, "ada__strings__searchS");
   u00133 : constant Version_32 := 16#67eb6d5a#;
   pragma Export (C, u00133, "ada__text_ioB");
   u00134 : constant Version_32 := 16#3cf1122b#;
   ...
   u00171 : constant Version_32 := 16#ad0ace1a#;
   pragma Export (C, u00171, "system__wid_lluS");
   u00172 : constant Version_32 := 16#b1351eea#;
   pragma Export (C, u00172, "system__img_lllbS");
   u00173 : constant Version_32 := 16#868c229b#;
   pragma Export (C, u00173, "system__img_llliS");
   u00174 : constant Version_32 := 16#eaaea841#;
   pragma Export (C, u00174, "system__val_llliS");
   u00175 : constant Version_32 := 16#5ce094b2#;
   pragma Export (C, u00175, "system__val_llluS");
   u00176 : constant Version_32 := 16#ceb71b59#;
   pragma Export (C, u00176, "system__wid_llluS");
   u00177 : constant Version_32 := 16#bb4107e6#;
   pragma Export (C, u00177, "system__img_lllwS");
   u00178 : constant Version_32 := 16#9af69e93#;
   pragma Export (C, u00178, "system__img_llwS");
   u00179 : constant Version_32 := 16#b4409774#;
   pragma Export (C, u00179, "system__img_wiuS");
   u00180 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00180, "system__concat_3B");
   u00181 : constant Version_32 := 16#c817b61a#;
   pragma Export (C, u00181, "system__concat_3S");
   u00182 : constant Version_32 := 16#7f5b11f9#;
   pragma Export (C, u00182, "gid__decoding_pngB");
   u00183 : constant Version_32 := 16#02e7cb31#;
   pragma Export (C, u00183, "gid__decoding_pngS");
   u00184 : constant Version_32 := 16#e6e0265c#;
   pragma Export (C, u00184, "gid__decoding_png__huffmanB");
   u00185 : constant Version_32 := 16#39874414#;
   pragma Export (C, u00185, "gid__decoding_png__huffmanS");
   u00186 : constant Version_32 := 16#3124cfea#;
   pragma Export (C, u00186, "system__concat_8B");
   u00187 : constant Version_32 := 16#cfe2ff79#;
   ...
   u00189 : constant Version_32 := 16#64082409#;
   pragma Export (C, u00189, "gid__decoding_pnmB");
   u00190 : constant Version_32 := 16#16bfc7c5#;
   pragma Export (C, u00190, "gid__decoding_pnmS");
   u00191 : constant Version_32 := 16#a5571fec#;
   pragma Export (C, u00191, "ada__strings__unboundedB");
   u00192 : constant Version_32 := 16#efe6e98c#;
   pragma Export (C, u00192, "ada__strings__unboundedS");
   u00193 : constant Version_32 := 16#21641b9a#;
   pragma Export (C, u00193, "system__compare_array_unsigned_8B");
   u00194 : constant Version_32 := 16#d28b31db#;
   ...
   u00196 : constant Version_32 := 16#3c598318#;
   pragma Export (C, u00196, "system__address_operationsS");
   u00197 : constant Version_32 := 16#7b453c33#;
   ...
   u00199 : constant Version_32 := 16#9e75407b#;
   pragma Export (C, u00199, "system__atomic_countersS");
   u00200 : constant Version_32 := 16#049b8b2c#;
   pragma Export (C, u00200, "gid__decoding_qoiB");
   u00201 : constant Version_32 := 16#530c377f#;
   pragma Export (C, u00201, "gid__decoding_qoiS");
   u00202 : constant Version_32 := 16#94538365#;
   pragma Export (C, u00202, "gid__decoding_tgaB");
   u00203 : constant Version_32 := 16#34f9aa55#;
   pragma Export (C, u00203, "gid__decoding_tgaS");
   u00204 : constant Version_32 := 16#a8f80fe0#;
   pragma Export (C, u00204, "gid__headersB");
   u00205 : constant Version_32 := 16#4a51dbbc#;
   pragma Export (C, u00205, "gid__headersS");
   u00206 : constant Version_32 := 16#bf56f131#;
   pragma Export (C, u00206, "system__strings__stream_opsB");
   u00207 : constant Version_32 := 16#ba9b6df2#;
   pragma Export (C, u00207, "system__strings__stream_opsS");
   u00208 : constant Version_32 := 16#a440ec49#;
   pragma Export (C, u00208, "ada__calendarB");
   u00209 : constant Version_32 := 16#8324cd02#;
   pragma Export (C, u00209, "ada__calendarS");
   u00210 : constant Version_32 := 16#307180be#;
   pragma Export (C, u00210, "system__os_primitivesB");
   u00211 : constant Version_32 := 16#4590ca4e#;
   pragma Export (C, u00211, "system__os_primitivesS");
   ...
   u00224 : constant Version_32 := 16#ad98c70a#;
   pragma Export (C, u00224, "pdf_out__fontsB");
   u00225 : constant Version_32 := 16#6130267c#;
   pragma Export (C, u00225, "pdf_out__fontsS");
   ...
   u00228 : constant Version_32 := 16#4bb24b3e#;
   pragma Export (C, u00228, "pdf_out__imagesB");
   u00229 : constant Version_32 := 16#f31a3b3b#;
   pragma Export (C, u00229, "pdf_out__imagesS");
   u00230 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00230, "system__concat_4B");
   u00231 : constant Version_32 := 16#7195f086#;
   pragma Export (C, u00231, "system__concat_4S");
   u00232 : constant Version_32 := 16#63bad2e6#;
   pragma Export (C, u00232, "system__concat_9B");
   u00233 : constant Version_32 := 16#168267d3#;
   pragma Export (C, u00233, "system__concat_9S");
   u00234 : constant Version_32 := 16#f1d549fe#;
   pragma Export (C, u00234, "system__img_fltS");
   u00235 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00235, "system__float_controlB");
   u00236 : constant Version_32 := 16#a291ec84#;
   pragma Export (C, u00236, "system__float_controlS");
   ...
   u00239 : constant Version_32 := 16#e7771600#;
   pragma Export (C, u00239, "system__powten_fltS");
   u00240 : constant Version_32 := 16#2a9b675e#;
   pragma Export (C, u00240, "system__img_lfltS");
   u00241 : constant Version_32 := 16#585f81ee#;
   pragma Export (C, u00241, "system__img_lluS");
   u00242 : constant Version_32 := 16#ee65fd70#;
   pragma Export (C, u00242, "system__powten_lfltS");
   u00243 : constant Version_32 := 16#614b4032#;
   pragma Export (C, u00243, "system__img_llfS");
   u00244 : constant Version_32 := 16#d9f447fb#;
   pragma Export (C, u00244, "system__powten_llfS");
   u00245 : constant Version_32 := 16#298df3f9#;
   pragma Export (C, u00245, "system__storage_pools__subpoolsB");
   u00246 : constant Version_32 := 16#3fcf28a8#;
   pragma Export (C, u00246, "system__storage_pools__subpoolsS");
   u00247 : constant Version_32 := 16#b0df1928#;
   pragma Export (C, u00247, "system__storage_pools__subpools__finalizationB");
   u00248 : constant Version_32 := 16#562129f7#;
   pragma Export (C, u00248, "system__storage_pools__subpools__finalizationS");
   ...
   u00255 : constant Version_32 := 16#5d191d0e#;
   pragma Export (C, u00255, "ada__streams__stream_ioB");
   u00256 : constant Version_32 := 16#5b183aea#;
   pragma Export (C, u00256, "ada__streams__stream_ioS");
   u00257 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00257, "system__communicationB");
   u00258 : constant Version_32 := 16#dfb0b3e3#;
