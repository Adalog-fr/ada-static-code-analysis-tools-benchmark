pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__pdf_out_demo.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__pdf_out_demo.adb");
...
package body ada_main is
   ...
   E222 : Short_Integer; pragma Import (Ada, E222, "system__storage_pools_E");
   E220 : Short_Integer; pragma Import (Ada, E220, "system__finalization_masters_E");
   ...
   E212 : Short_Integer; pragma Import (Ada, E212, "ada__calendar_E");
   E120 : Short_Integer; pragma Import (Ada, E120, "ada__text_io_E");
   E224 : Short_Integer; pragma Import (Ada, E224, "system__pool_global_E");
   E176 : Short_Integer; pragma Import (Ada, E176, "system__img_llli_E");
   E173 : Short_Integer; pragma Import (Ada, E173, "system__img_lli_E");
   E242 : Short_Integer; pragma Import (Ada, E242, "system__img_llu_E");
   E150 : Short_Integer; pragma Import (Ada, E150, "gid_E");
   E154 : Short_Integer; pragma Import (Ada, E154, "gid__buffering_E");
   E158 : Short_Integer; pragma Import (Ada, E158, "gid__color_tables_E");
   E152 : Short_Integer; pragma Import (Ada, E152, "gid__decoding_bmp_E");
   E156 : Short_Integer; pragma Import (Ada, E156, "gid__decoding_gif_E");
   E168 : Short_Integer; pragma Import (Ada, E168, "gid__decoding_jpg_E");
   E186 : Short_Integer; pragma Import (Ada, E186, "gid__decoding_png_E");
   E188 : Short_Integer; pragma Import (Ada, E188, "gid__decoding_png__huffman_E");
   E193 : Short_Integer; pragma Import (Ada, E193, "gid__decoding_pnm_E");
   E204 : Short_Integer; pragma Import (Ada, E204, "gid__decoding_qoi_E");
   E206 : Short_Integer; pragma Import (Ada, E206, "gid__decoding_tga_E");
   E208 : Short_Integer; pragma Import (Ada, E208, "gid__headers_E");
   E142 : Short_Integer; pragma Import (Ada, E142, "pdf_out_E");
   E228 : Short_Integer; pragma Import (Ada, E228, "pdf_out__fonts_E");
   E232 : Short_Integer; pragma Import (Ada, E232, "pdf_out__images_E");
   E137 : Short_Integer; pragma Import (Ada, E137, "fancy_page_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "fancy_page__finalize_spec");
      begin
         F1;
      end;
      E142 := E142 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "pdf_out__finalize_spec");
      begin
         F2;
      end;
      E150 := E150 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "gid__finalize_spec");
      begin
         F3;
      end;
      E224 := E224 - 1;
   ...
   begin
      ...
      PDF_OUT'ELAB_BODY;
      E142 := E142 + 1;
      Fancy_Page'Elab_Spec;
      Fancy_Page'Elab_Body;
      E137 := E137 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_pdf_out_demo");
...
--  BEGIN Object file/option list
   --   /workspaces/bench-source/src/apdf/obj_debug/bar_code.o
   ...
   --   /workspaces/bench-source/src/apdf/obj_debug/fancy_page.o
   --   /workspaces/bench-source/src/apdf/obj_debug/insert_mascot.o
   --   /workspaces/bench-source/src/apdf/obj_debug/qr_code.o
   --   /workspaces/bench-source/src/apdf/obj_debug/pdf_out_demo.o
