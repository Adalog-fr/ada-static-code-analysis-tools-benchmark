...
with Gpr_Parser.Unparsing; use Gpr_Parser.Unparsing;
...
procedure Parse is
   ...
   procedure Process_Lookups (Node : Gpr_Node'Class);
   procedure Process_Node (Res : Gpr_Node'Class);
   ...
   procedure Process_Lookups (Node : Gpr_Node'Class) is
   begin
   ...
   procedure Process_Node (Res : Gpr_Node'Class) is
   begin
      if Is_Null (Res) then
         Put_Line ("<null node>");
         return;
   ...
   is
      ...
      procedure Check_Consistency
        (Node, Parent : Gpr_Node);

      procedure Check_Consistency
        (Node, Parent : Gpr_Node) is
      begin
