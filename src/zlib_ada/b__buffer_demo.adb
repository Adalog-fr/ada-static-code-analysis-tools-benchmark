pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__buffer_demo.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__buffer_demo.adb");
...
package body ada_main is
   ...
   E144 : Short_Integer; pragma Import (Ada, E144, "zlib_E");
   E152 : Short_Integer; pragma Import (Ada, E152, "zlib__thin_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_buffer_demo");
...
--  BEGIN Object file/option list
   ...
   --   /workspaces/bench-source/src/zlib_ada/buffer_demo.o
