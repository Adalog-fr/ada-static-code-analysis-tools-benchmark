...
package body ada_main is
   ...
   E130 : Short_Integer; pragma Import (Ada, E130, "ada__streams__stream_io_E");
   ...
   E172 : Short_Integer; pragma Import (Ada, E172, "zlib_E");
   E182 : Short_Integer; pragma Import (Ada, E182, "zlib__thin_E");
   E192 : Short_Integer; pragma Import (Ada, E192, "zlib__streams_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "zlib__streams__finalize_spec");
      begin
         F1;
      end;
      E172 := E172 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "zlib__finalize_spec");
      begin
         F2;
      end;
      E188 := E188 - 1;
   ...
   begin
      ...
      Zlib'Elab_Body;
      E172 := E172 + 1;
      Zlib.Streams'Elab_Spec;
      Zlib.Streams'Elab_Body;
      E192 := E192 + 1;
   end adainit;
...
--  BEGIN Object file/option list
   ...
   --   /workspaces/bench-source/src/zlib_ada/zlib-streams.o
   --   /workspaces/bench-source/src/zlib_ada/test.o
