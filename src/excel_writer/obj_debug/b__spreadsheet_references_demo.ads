...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_spreadsheet_references_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e984c731#;
   pragma Export (C, u00001, "spreadsheet_references_demoB");
   ...
   u00119 : constant Version_32 := 16#6764a5cb#;
   pragma Export (C, u00119, "spreadsheet_referencesB");
   u00120 : constant Version_32 := 16#113668a7#;
   pragma Export (C, u00120, "spreadsheet_referencesS");
   u00121 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00121, "system__concat_2B");
   u00122 : constant Version_32 := 16#f796dc4f#;
   pragma Export (C, u00122, "system__concat_2S");
   u00123 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00123, "system__concat_4B");
   u00124 : constant Version_32 := 16#7195f086#;
   pragma Export (C, u00124, "system__concat_4S");
   u00125 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00125, "system__concat_3B");
   u00126 : constant Version_32 := 16#c817b61a#;
   pragma Export (C, u00126, "system__concat_3S");
   u00127 : constant Version_32 := 16#e6e7837e#;
   pragma Export (C, u00127, "system__exn_intS");
   u00128 : constant Version_32 := 16#7d9ea9cb#;
   pragma Export (C, u00128, "text_ioS");
   ...
   --  system.exn_int%s
   --  text_io%s
   --  spreadsheet_references%s
   --  spreadsheet_references%b
   --  spreadsheet_references_demo%b
