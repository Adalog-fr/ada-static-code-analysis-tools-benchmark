...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_biff_dump" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b54a71b1#;
   pragma Export (C, u00001, "biff_dumpB");
   ...
   u00105 : constant Version_32 := 16#3f1ef2d1#;
   pragma Export (C, u00105, "ada__directoriesB");
   u00106 : constant Version_32 := 16#3a2e0f67#;
   pragma Export (C, u00106, "ada__directoriesS");
   u00107 : constant Version_32 := 16#a440ec49#;
   pragma Export (C, u00107, "ada__calendarB");
   u00108 : constant Version_32 := 16#8324cd02#;
   pragma Export (C, u00108, "ada__calendarS");
   u00109 : constant Version_32 := 16#307180be#;
   pragma Export (C, u00109, "system__os_primitivesB");
   u00110 : constant Version_32 := 16#4590ca4e#;
   ...
   u00181 : constant Version_32 := 16#44bc8f6a#;
   pragma Export (C, u00181, "ada__text_io__generic_auxB");
   u00182 : constant Version_32 := 16#ba6faca0#;
   pragma Export (C, u00182, "ada__text_io__generic_auxS");
   u00183 : constant Version_32 := 16#20faca4b#;
   pragma Export (C, u00183, "excel_outB");
   u00184 : constant Version_32 := 16#65de6098#;
   pragma Export (C, u00184, "excel_outS");
   u00185 : constant Version_32 := 16#58dd374e#;
   pragma Export (C, u00185, "ieee_754S");
   u00186 : constant Version_32 := 16#415c2929#;
   pragma Export (C, u00186, "ieee_754__generic_double_precisionB");
   u00187 : constant Version_32 := 16#3294e14f#;
   pragma Export (C, u00187, "ieee_754__generic_double_precisionS");
   u00188 : constant Version_32 := 16#8b9a2c46#;
   pragma Export (C, u00188, "system__img_biuS");
   u00189 : constant Version_32 := 16#c6c4eb98#;
   pragma Export (C, u00189, "system__img_llbS");
   u00190 : constant Version_32 := 16#602bc0ef#;
   pragma Export (C, u00190, "system__img_lliS");
   u00191 : constant Version_32 := 16#ad0ace1a#;
   pragma Export (C, u00191, "system__wid_lluS");
   u00192 : constant Version_32 := 16#b1351eea#;
   pragma Export (C, u00192, "system__img_lllbS");
   u00193 : constant Version_32 := 16#868c229b#;
   pragma Export (C, u00193, "system__img_llliS");
   u00194 : constant Version_32 := 16#eaaea841#;
   pragma Export (C, u00194, "system__val_llliS");
   u00195 : constant Version_32 := 16#5ce094b2#;
   pragma Export (C, u00195, "system__val_llluS");
   u00196 : constant Version_32 := 16#ceb71b59#;
   pragma Export (C, u00196, "system__wid_llluS");
   u00197 : constant Version_32 := 16#bb4107e6#;
   pragma Export (C, u00197, "system__img_lllwS");
   u00198 : constant Version_32 := 16#9af69e93#;
   pragma Export (C, u00198, "system__img_llwS");
   u00199 : constant Version_32 := 16#b4409774#;
   pragma Export (C, u00199, "system__img_wiuS");
   u00200 : constant Version_32 := 16#5d191d0e#;
   pragma Export (C, u00200, "ada__streams__stream_ioB");
   u00201 : constant Version_32 := 16#5b183aea#;
   pragma Export (C, u00201, "ada__streams__stream_ioS");
   u00202 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00202, "system__communicationB");
   u00203 : constant Version_32 := 16#dfb0b3e3#;
   pragma Export (C, u00203, "system__communicationS");
   ...
   u00208 : constant Version_32 := 16#4ace4092#;
   pragma Export (C, u00208, "system__byte_swappingS");
   u00209 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00209, "system__concat_2B");
   u00210 : constant Version_32 := 16#f796dc4f#;
   pragma Export (C, u00210, "system__concat_2S");
   u00211 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00211, "system__concat_3B");
   u00212 : constant Version_32 := 16#c817b61a#;
   pragma Export (C, u00212, "system__concat_3S");
   u00213 : constant Version_32 := 16#f1d549fe#;
   pragma Export (C, u00213, "system__img_fltS");
   u00214 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00214, "system__float_controlB");
   u00215 : constant Version_32 := 16#a291ec84#;
   pragma Export (C, u00215, "system__float_controlS");
   u00216 : constant Version_32 := 16#4f0058da#;
   pragma Export (C, u00216, "system__img_utilB");
   u00217 : constant Version_32 := 16#35740b01#;
   pragma Export (C, u00217, "system__img_utilS");
   u00218 : constant Version_32 := 16#e7771600#;
   pragma Export (C, u00218, "system__powten_fltS");
   u00219 : constant Version_32 := 16#2a9b675e#;
   pragma Export (C, u00219, "system__img_lfltS");
   u00220 : constant Version_32 := 16#585f81ee#;
   pragma Export (C, u00220, "system__img_lluS");
   u00221 : constant Version_32 := 16#ee65fd70#;
   pragma Export (C, u00221, "system__powten_lfltS");
   u00222 : constant Version_32 := 16#614b4032#;
   pragma Export (C, u00222, "system__img_llfS");
   u00223 : constant Version_32 := 16#d9f447fb#;
   pragma Export (C, u00223, "system__powten_llfS");
   u00224 : constant Version_32 := 16#4b99adb9#;
   pragma Export (C, u00224, "system__sequential_ioB");
   u00225 : constant Version_32 := 16#73d22178#;
   pragma Export (C, u00225, "system__sequential_ioS");
   u00226 : constant Version_32 := 16#95f8767f#;
   pragma Export (C, u00226, "system__val_fltS");
   u00227 : constant Version_32 := 16#e77d8041#;
   pragma Export (C, u00227, "system__exn_fltS");
   u00228 : constant Version_32 := 16#7054388e#;
   pragma Export (C, u00228, "system__val_lfltS");
   u00229 : constant Version_32 := 16#593c6198#;
   pragma Export (C, u00229, "system__exn_lfltS");
   u00230 : constant Version_32 := 16#d0838ac3#;
   pragma Export (C, u00230, "system__val_llfS");
   u00231 : constant Version_32 := 16#7492a1e8#;
   pragma Export (C, u00231, "system__exn_llfS");
   ...
   --  system.img_llf%s
   --  ieee_754%s
   --  ieee_754.generic_double_precision%s
   --  ieee_754.generic_double_precision%b
   --  excel_out%s
   --  excel_out%b
   --  biff_dump%b
