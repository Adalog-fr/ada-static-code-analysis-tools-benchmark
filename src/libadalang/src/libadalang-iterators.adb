...
package body Libadalang.Iterators is
   ...
   package Predicate_Vectors is new Ada.Containers.Vectors
     (Index_Type   => Positive,
      Element_Type => Ada_Node_Predicate,
   ...
   is
   begin
      return Result : Ada_Node_Predicate_Array (1 .. Natural (Predicates.Length)) do
   ...
   begin
      return Result : Ada_Node_Predicate do
         Result.Set
           (Not_Predicate'(Ada_Node_Predicate_Interface with Predicate => Predicate));
      end return;
   end "not";
   ...
   function "and" (Left, Right : Ada_Node_Predicate) return Ada_Node_Predicate is
   begin
   ...
   function "or" (Left, Right : Ada_Node_Predicate) return Ada_Node_Predicate is
   begin
   ...
   function For_All (Predicates : Ada_Node_Predicate_Array) return Ada_Node_Predicate is
   ...
   function For_Some (Predicates : Ada_Node_Predicate_Array) return Ada_Node_Predicate is
      Preds : Predicate_Vectors.Vector;
   begin
   ...
   function For_All_Children
     (Predicate : Ada_Node_Predicate; Skip_Null : Boolean := True) return Ada_Node_Predicate
   is
   begin
      return Result : Ada_Node_Predicate do
   ...
   function Child_With
     (Field     : Syntax_Field_Reference;
      Predicate : Ada_Node_Predicate) return Ada_Node_Predicate is
   begin
         return Result : Ada_Node_Predicate do
   ...
   function Kind_In (First, Last : Ada_Node_Kind_Type) return Ada_Node_Predicate is
   begin
      return Result : Ada_Node_Predicate do
         Result.Set (Kind_Predicate'(Ada_Node_Predicate_Interface with
                                     First => First,
                                     Last  => Last));
      end return;
   end Kind_In;
   ...
   begin
      return Result : Ada_Node_Predicate do
         Result.Set (Text_Predicate'(Ada_Node_Predicate_Interface
   ...
   begin
      return Result : Ada_Node_Predicate do
         Result.Set (Node_Is_Null_Predicate'(Ada_Node_Predicate_Interface with null record));
      end return;
   end Node_Is_Null;
   ...
   overriding function Evaluate
     (P : in out Not_Predicate; N : Ada_Node) return Boolean is
   begin
   ...
   overriding function Evaluate
     (P : in out For_All_Predicate; N : Ada_Node) return Boolean is
   begin
   ...
   overriding function Evaluate
     (P : in out For_Some_Predicate; N : Ada_Node) return Boolean is
   begin
      for Predicate of P.Predicates loop
   ...
   is
      Child_Pred : Ada_Node_Predicate_Interface'Class renames P.Predicate.Unchecked_Get.all;
   begin
   ...
   overriding function Evaluate
     (P : in out Child_With_Predicate; N : Ada_Node) return Boolean is
   begin
      if N.Is_Null then
         return False;
      end if;
   ...
   overriding function Evaluate
     (P : in out Kind_Predicate; N : Ada_Node) return Boolean is
   begin
