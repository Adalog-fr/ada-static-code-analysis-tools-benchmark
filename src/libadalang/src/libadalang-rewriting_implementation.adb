      ...
      Pre_Check
        (Handle /= No_Rewriting_Handle,
         ...
         function Create_Accept_Stmt
           (Handle : Rewriting_Handle
               ; Accept_Stmt_F_Name : Node_Rewriting_Handle
         ...
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Ada_Accept_Stmt,
               (1 => Accept_Stmt_F_Name, 2 => Accept_Stmt_F_Entry_Index_Expr, 3 => Accept_Stmt_F_Params));
         end;
         ...
         "Handle should not be null");
            ...
            return Create_Regular_Node
              (Handle, Ada_Accept_Stmt_With_Stmts,
               (1 => Accept_Stmt_F_Name, 2 => Accept_Stmt_F_Entry_Index_Expr, 3 => Accept_Stmt_F_Params, 4 => Accept_Stmt_With_Stmts_F_Stmts, 5 => Accept_Stmt_With_Stmts_F_End_Name));
         end;
