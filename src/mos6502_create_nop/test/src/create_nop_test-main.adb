...
with AdaCL.Trace;
with Create_NOP_Test.Suite;

procedure Create_NOP_Test.Main is
   Trace : AdaCL.Trace.Object := AdaCL.Trace.Function_Trace;
   pragma Unreferenced (Trace);

   use type AUnit.Status;

   function Run is new AUnit.Run.Test_Runner_With_Status (Create_NOP_Test.Suite.Suite);
