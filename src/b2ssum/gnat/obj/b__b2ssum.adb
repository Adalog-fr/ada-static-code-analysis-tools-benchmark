pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__b2ssum.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__b2ssum.adb");
...
package body ada_main is
   ...
   E160 : Short_Integer; pragma Import (Ada, E160, "ada__text_io__text_streams_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_b2ssum");
...
--  BEGIN Object file/option list
   --   /workspaces/bench-source/src/b2ssum/gnat/obj/b2ssum.o
   --   -L/workspaces/bench-source/src/b2ssum/gnat/obj/
   --   -L/workspaces/bench-source/src/b2ssum/gnat/obj/
   --   -L/workspaces/bench-source/src/b2ssum/gnat/lib/
