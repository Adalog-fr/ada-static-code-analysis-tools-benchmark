...
package body Gtk.Meter.Round_90 is
   ...
   begin
      ...
      Widget.Major_Ticks :=
         ...
         (  Under => Widget.Background.Get_Foreground,
            Outer =>
               (  Center          => (0.0, 0.0 + Pin),
                  Major_Curvature => 1.0 / (Height * 1.05),
                  Minor_Radius    => Height * 1.05,
                  Angle           => 0.0
               ),
            Inner =>
               (  Center          => (0.0, 0.0 + Pin),
                  Major_Curvature => 1.0 / (Height * 0.85),
      ...
      Widget.Middle_Ticks :=
         ...
         (  Under => Widget.Background.Get_Foreground,
            Outer =>
               (  Center          => (0.0, 0.0 + Pin),
                  Major_Curvature => 1.0 / (Height * 1.00),
                  Minor_Radius    => Height * 1.00,
                  Angle           => 0.0
               ),
            Inner =>
               (  Center          => (0.0, 0.0 + Pin),
      ...
      Widget.Minor_Ticks :=
         ...
         (  Under => Widget.Background.Get_Foreground,
            Outer =>
               (  Center          => (0.0, 0.0 + Pin),
                  Major_Curvature => 1.0 / (Height * 0.95),
   ...
   begin
      Widget := new Gtk_Meter_Round_90_Record;
   ...
   begin
      ...
      Widget.Annotation :=
         ...
         (  Under   => Widget.Cache,
            Ellipse =>
               (  Center          => (0.0, 0.0 + Pin),
                  Major_Curvature => 1.0 / (Height * 1.15),
