...
package body Gtk.Gauge.Round_180 is
   ...
   begin
      ...
      Widget.Minor_Ticks :=
         ...
         (  Under   => Widget.Background.Get_Foreground,
            Inner   => ((X, Y), 1.0 / 0.45, 0.45, 0.0),
            Outer   => ((X, Y), 1.0 / 0.48, 0.48, 0.0),
   ...
   function Get_Annotation
            (  Widget : not null access Gtk_Gauge_Round_180_Record
   ...
   begin
      Widget := new Gtk_Gauge_Round_180_Record;
