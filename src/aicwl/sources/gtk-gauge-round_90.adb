...
package body Gtk.Gauge.Round_90 is

   Needle_Color      : constant Gdk_Color := RGB (1.0, 0.0, 0.0);
   Pin_Color         : constant Gdk_Color := RGB (0.3, 0.3, 0.3);
   Background_Color  : constant Gdk_Color := RGB (0.2, 0.2, 0.2);
   Line_Color        : constant Gdk_Color := RGB (1.0, 1.0, 1.0);
   ...
   Length : constant := Pi / 2.0 - Pi / 12.0;
   First  : constant := 3.0 * Pi / 2.0 - Length / 1.9;
   Offset : constant := 0.407;
   ...
   begin
      ...
      Set_Aspect_Ratio (Widget, 1.64490909931998);
      Widget.Background :=
         Add_Elliptic_Background
         (  Under         => Widget,
            Color         => Background_Color,
            Outer         => ((0.0, Offset), 1.0 / 0.713, 0.713, 0.0),
            Inner         => ((0.0, Offset), 0.0, 0.1, Pi),
            Border_Width  => 0.01,
            Border_Depth  => 0.005,
      ...
      Widget.Pin :=
         ...
         (  Under         => Widget.Background.Get_Foreground,
            Color         => Pin_Color,
            Outer         => ((0.0, Offset - 0.008), 1.0 / 0.3, 0.3, 0.0),
            Inner         => ((0.0, Offset - 0.008), 0.0, 0.099, Pi),
            Border_Width  => 0.01,
            Border_Depth  => 0.005,
      ...
      Widget.Line :=
         ...
         (  Under   => Widget.Background.Get_Foreground,
            Color   => Line_Color,
            Width   => 1.0 / 200.0,
            Ellipse => ((0.0, Offset), 1.0 / 0.67, 0.67, 0.0),
            From    => First,
            Length  => Length,
            Widened => True,
            Scaled  => True
      ...
      Widget.Minor_Ticks :=
         Add_Elliptic_Scale
         (  Under   => Widget.Background.Get_Foreground,
            Inner   => ((0.0, Offset), 1.0 / 0.65, 0.65, 0.0),
            Outer   => ((0.0, Offset), 1.0 / 0.67, 0.67, 0.0),
            Color   => Middle_Tick_Color,
            Width   => 1.0 / 400.0,
            Skipped => 5,
            Step    => Length / (10.0 * GDouble (Widget.Sectors)),
            From    => First,
            Length  => Length,
            Scaled  => True,
            Widened => True
      ...
      Widget.Middle_Ticks :=
         Add_Elliptic_Scale
         (  Under   => Widget.Background.Get_Foreground,
            Inner   => ((0.0, Offset), 1.0 / 0.63, 0.63, 0.0),
            Outer   => ((0.0, Offset), 1.0 / 0.67, 0.67, 0.0),
            Color   => Middle_Tick_Color,
            Width   => 1.5 / 400.0,
            Skipped => 2,
      ...
      Widget.Major_Ticks :=
         Add_Elliptic_Scale
         (  Under   => Widget.Background.Get_Foreground,
            Inner   => ((0.0, Offset), 1.0 / 0.60, 0.60, 0.0),
            Outer   => ((0.0, Offset), 1.0 / 0.67, 0.67, 0.0),
   ...
   function Get_Annotation
            (  Widget : not null access Gtk_Gauge_Round_90_Record
   ...
   begin
      Widget := new Gtk_Gauge_Round_90_Record;
   ...
   begin
      ...
      Widget.Annotation :=
         ...
         (  Under   => Widget.Cache,
            Ellipse => ((0.0, Offset), 1.0 / 0.52, 0.52, 0.0),
            Texts   => Texts,
            Face    => Create_Toy
                       (  Family => "arial",
