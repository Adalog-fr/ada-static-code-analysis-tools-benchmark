...
--
   Class_Name : constant String := "GtkGaugeFlatVertical";
--
-- Gtk_Gauge_Flat_Vertical -- Rectangular gauge
--
...
private
   ...
   type Gtk_Gauge_Flat_Vertical_Record is new Gtk_Layered_Record with
   record
      Sectors      : Positive := 10;
