...
package body Gtk.Gauge.Rectangular_70s is
   ...
   Height : constant := 1.0 / 5.0;
   Length : constant := 1.3 * Pi / 2.0;
   Pin    : constant := Height * 1.2;
   ...
   begin
      Widget := new Gtk_Gauge_Rectangular_70s_Record;
