...
package Gtk.Gauge.Round_110 is
--
-- Class_Name - Of the widget
--
   Class_Name : constant String := "GtkGaugeRound110";
--
-- Gtk_Gauge_Round_110 -- Round 180 degrees gauge
--
...
private
   ...
   record
      ...
      Arrows_Area  : access Elliptic_Background_Layer;
