...
package Gtk.Meter.Round_90 is
   use Gtk.Layered.Elliptic_Annotation;
   use Gtk.Layered.Rectangular_Background;
--
-- Class_Name - Of the widget
--
   Class_Name : constant String := "GtkMeterRound90";
--
-- Gtk_Meter_Round_90 -- Rectangular gauge
--
...
private
   ...
   type Gtk_Meter_Round_90_Record is new Gtk_Layered_Record with
   record
      Sectors      : Positive := 12;
