...
package body Gtk.Gauge.Round_270_60s is
   ...
   Needle_Color      : constant Gdk_Color := RGB (1.00, 0.00, 0.00);
   Pin_Color         : constant Gdk_Color := RGB (0.70, 0.70, 0.70);
   Background_Color  : constant Gdk_Color := RGB (0.17, 0.12, 0.11);
   Major_Tick_Color  : constant Gdk_Color := RGB (1.00, 1.00, 1.00);
   Middle_Tick_Color : constant Gdk_Color := RGB (1.00, 1.00, 1.00);
   Minor_Tick_Color  : constant Gdk_Color := RGB (1.00, 1.00, 1.00);
   Text_Color        : constant Gdk_Color := RGB (1.00, 1.00, 1.00);
