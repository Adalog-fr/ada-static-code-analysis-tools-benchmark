...
package Gtk.Meter.Round_94 is
   use Gtk.Layered.Elliptic_Annotation;
   use Gtk.Layered.Elliptic_Background;
--
-- Class_Name - Of the widget
--
   Class_Name : constant String := "GtkMeterRound94";
--
-- Gtk_Meter_Round_94 -- Rectangular gauge
--
...
private
   ...
   type Gtk_Meter_Round_94_Record is new Gtk_Layered_Record with
   record
      Sectors      : Positive := 5;
