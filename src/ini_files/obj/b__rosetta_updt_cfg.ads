...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_rosetta_updt_cfg" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5ea75f58#;
   pragma Export (C, u00001, "rosetta_updt_cfgB");
   ...
   u00119 : constant Version_32 := 16#26ce530e#;
   pragma Export (C, u00119, "configB");
   u00120 : constant Version_32 := 16#5899874d#;
   pragma Export (C, u00120, "configS");
   u00121 : constant Version_32 := 16#b98a4d98#;
   pragma Export (C, u00121, "ada__strings__fixedB");
   u00122 : constant Version_32 := 16#1bd3eed0#;
