pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__rosetta_updt_cfg_reset.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__rosetta_updt_cfg_reset.adb");
...
package body ada_main is
   ...
   E139 : Short_Integer; pragma Import (Ada, E139, "config_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "config__finalize_spec");
      begin
         F1;
      end;
      E122 := E122 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_rosetta_updt_cfg_reset");
...
--  BEGIN Object file/option list
   --   /workspaces/bench-source/src/ini_files/obj/config.o
   --   /workspaces/bench-source/src/ini_files/obj/rosetta_updt_cfg.o
   --   /workspaces/bench-source/src/ini_files/obj/rosetta_updt_cfg_reset.o
   --   -L/workspaces/bench-source/src/ini_files/obj/
   --   -L/workspaces/bench-source/src/ini_files/obj/
