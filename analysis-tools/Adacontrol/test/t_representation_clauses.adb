...
procedure T_representation_clauses is
   ...
   for T'Size use 8;                 -- not object 'Size, 'Size

   X,Y : T;
   for X'Address use To_Address (0); -- not global 'Address, 'Address
   for Y use at To_Address (4);      -- 83 address clause
   for Y'Size use 16;                -- object 'Size, 'Size

   I, J, K: Integer;
   for I'Address use J'Address;      -- not global 'Address, 'Address, rng_over, overlay
   ...
   for Tab'Size use Integer'Size * 10;   -- arr_size, not_obj_size, 'Size, non_power2
   V1 : Tab;
   V2 : Tab;
   for V2'Address use V1'Address;        -- Arr_Addr, not_glob_addr, 'Address, tab_over, overlay
   type RecTab is
      record
         S : String (1 .. 10);
      end record;
   for RecTab'Bit_Order use Low_Order_First;
   for RecTab'Size use 88;               -- rec_size, not_obj_size, 'size, non_power2
