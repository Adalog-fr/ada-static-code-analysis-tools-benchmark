...
package body Adactl_Options is
   ...
   package Analyzer is
      new Options_Analyzer (Binary_Options => "aCdDeEhiIjrsTuvwx",
   ...
   begin
      User_Message ("Usage: adactl [-adeEirsTuvwx]");
      ...
      User_Message ("   -a        ignore aspect specifications");
   ...
   begin -- Analyse_Options
      ...
      Flag_To_Command  ('a', "aspect", Inverted => True);
...
begin  -- Adactl_Options
   ...
   Register (Aspect_Option'Access,  Variable_Name => "ASPECT");
