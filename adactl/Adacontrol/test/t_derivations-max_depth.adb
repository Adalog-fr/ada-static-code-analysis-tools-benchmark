...
procedure Max_Depth is
   ...
   subtype Ren_T1 is T1;
   subtype Ren_I2 is I2;
   subtype Ren_Ren_I2 is Ren_I2;

   package Pack_1 is
      type PT0 is new Ren_T1 with null record;
   end Pack_1;
   subtype Ren_PT0 is Pack_1.PT0;

   type T6 is new I2 with null record;
   type T7 is new Ren_I2 with null record;
   type T8 is new Pack_1.PT0 with null record;
   type T9 is new Ren_PT0 and Ren_I2 with null record;
   type T10 is new Ren_Ren_I2 with null record;
   ...
   -- Check privacy
   package Pack is
      type T6 is new T4 with private;
      type T7 is private;
   private
      type T6 is new T4 with null record;                                   -- max 4, got 5
      type T7 is new Int4;                                                  -- max 1, got 5
   end Pack;

   type T8 is new Pack.T6 with null record;
   type T9 is new Pack.T7 ;
